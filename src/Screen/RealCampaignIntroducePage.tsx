...
const RealCampaignIntroducePage: React.FC<Props> = (props) => {
  ...
  return (
    <div className={classes.root}>
      <div className={classes.mainWord}>캠페인 설명</div>
      ...
      <div className={classes.planBox}>
        <div className={classes.content1}>
          ...
          <div className={classes.content1_Detail_Box}>
            <div className={classes.content1_Title}> 사업대상</div>
            <div className={classes.content1_Detail}>
              {`${props.data?.target}`}
            </div>
          </div>
          <div className={classes.content1_Detail_Box}>
            <div className={classes.content1_Title}> 대상 수</div>
            <div className={classes.content1_Detail}>
              {" "}
              {`${props.data ? props.data.content : 0}명`}
            </div>
          </div>
          <div className={classes.line1}></div>
        </div>
        <div className={classes.content2}>
          ...
          <div className={classes.content1_Title}> 물품 구매</div>
          <div className={classes.tableHeader}>
            <div className={classes.headerContent}>물품명</div>
            <div className={classes.headerContent}>개수</div>
            <div className={classes.headerContent}>예상비용</div>
            <div className={classes.headerContent}>예상구입처</div>
          </div>
          <div className={classes.contentBox}>
            {props.data ? (
              props.data.costPreviews.map((value, idx) => {
...
export default RealCampaignIntroducePage;
